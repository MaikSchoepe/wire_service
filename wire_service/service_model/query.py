...
from wire_service.service_model.cable import CableQuery
from wire_service.service_model.cable_type import CableTypeQuery
...
Query = merge_types(
    "Query", (AreaQuery, PlaceQuery, FaceQuery, OutletQuery, CableTypeQuery, CableQuery)
)
